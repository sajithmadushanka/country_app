...
export default function RegionStats({ countries }: { countries: Country[] }) {
  ...
  const mostPopulous = countries.reduce((a, b) => (a.population > b.population ? a : b));
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow">
      ...
      <p><strong>Most Populous:</strong> {mostPopulous.name} ({mostPopulous.population.toLocaleString()})</p>
    </div>
  );
}
